    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            ...
            <div class="row float-end">
                <a href="/admin/role" class="btn add-button btn-info me-1">
                                            ...
                                            <div class="card flex-fill">
                                                ...
                                                <div class="card-footer">
                                                        ...
                                                        <span class="toggle-switch-label text-center demo-checkbox">
                                                                ...
                                                                <input type="checkbox" id="md_checkbox_{{ $value->id }}" name="permission[]" value="{{ $value->id }}"
                                                                {{in_array($value->id, $rolePermissions) ? "checked" : "unchecked"}}
