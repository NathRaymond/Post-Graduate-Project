...
<div class="text-right">
    <button type="button" class="btn btn-success mb-2 mr-2" data-toggle="modal" data-target=".bd-example-modal-xl"
        id="edit-student" data-id="{{ $biodatas->id ?? '' }}">&plus; Update Biodata</button>
</div>
                ...
                <div class="box">
                    <center>
                        <div class="user-bg" style="padding: 10px 10px;">
                            <img src="{{ asset('profile_picture/avartar.jpg') }}" width="70%" alt="user picture">
                        </div>
                    </center>
                    <div class="box-body">
                        <div class="row text-center mt-10">
                            <div class="col-md-6 border-end">
                                <strong>Name</strong>
                                <p> {{ $biodatas->first_name ?? '' }} {{ $biodatas->last_name ?? '' }}</p>
                            </div>
                            <div class="col-md-6"><strong>Degree/Programme</strong>
                                <p> {{ $biodatas->dProgramme->description ?? ($biodatas->programme ?? '') }}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row text-center mt-10">
                        ...
                        <div class="row text-center mt-10">
                            <div class="col-md-12"><strong>Address</strong>
                                <p>{{ $homeaddress->hom_state ?? '' }} {{ $homeaddress->hom_street ?? '' }}
                                    {{ $homeaddress->hom_town ?? '' }} </p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-6 border-end"> <strong>Full
                                    Name</strong>
                                <br>
                                <p class="text-muted">{{ $biodatas->first_name ?? '' }}
                                    {{ $biodatas->last_name ?? '' }}</p>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-6 border-end">
                                ...
                                <br>
                                <p class="text-muted">
                                    {{ $studcontacts->Scount->name ?? ($studcontacts->cont_country_id ?? '') }}</p>
                            </div>
                            <div class="col-md-3 col-xs-6"> <strong>State of Origin</strong>
                                <br>
                                <p class="text-muted"> {{ $biodatas->state ?? '' }}</p>
                            </div>
                            <div class="col-md-3 col-xs-6 border-end"> <strong>Phone
                                    Number</strong>
                                <br>
                                <p class="text-muted">{{ $biodatas->phone ?? '' }}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-6 border-end">
                                ...
                                <br>
                                <p class="text-muted">
                                    {{ $homeaddress->Hcount->name ?? ($homeaddress->hom_country_id ?? '') }} </p>
                            </div>
                            <div class="col-md-3 col-xs-6 border-end">
                                <strong>State</strong>
                                <br>
