                    ...
                    <form method="post" action="{{ route('register-student') }}" class="tab-wizard wizard-circle"
                        ...
                        <section>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $biodatas->first_name ?? '' }}" name="first_name" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="firstName5" class="form-label">Last Name :</label>
                                        <input type="text" name="last_name" value="{{ $biodatas->last_name ?? '' }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="middle_name"
                                            value="{{ $biodatas->middle_name ?? '' }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="bioreligion" name="religion" required>
                                            <option value="{{ $biodatas->religion ?? '' }}">
                                                {{ $biodatas->religion ?? '' }}
                                            </option>
                                        ...
                                        <select class="form-select" id="country" name="country" required>
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}"
                                                    {{ $studcontacts->cont_country_id ?? '' == $country->id ? 'selected' : ' ' }}>
                                                    {{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                        ...
                                        <select class="form-select" id="biostate_of_origin" name="state_of_origin"
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{ $state->id_no }}"
                                                    {{ $biodatas->state_of_origin ?? '' == $state->id_no ? 'selected' : ' ' }}>
                                                    {{ $state->state }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="phone" value="{{ $biodatas->phone ?? '' }}"
                                            class="form-control" maxlength="11" name="phone" id="biophone_number"
                                            required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="alternativeemail" class="form-label">Alternative Email
                                            :</label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="biocont_state" name="cont_state" required>
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{ $state->id_no }}"
                                                    {{ $studcontacts->cont_state ?? '' == $state->id_no ? 'selected' : ' ' }}>
                                                    {{ $state->state }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="biohom_state" name="hom_state" required>
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{ $state->id_no }}"
                                                    {{ $homeaddress->hom_state ?? '' == $state->id_no ? 'selected' : ' ' }}>
                                                    {{ $state->state }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="hom_country_id" required>
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}"
                                                    {{ $homeaddress->hom_country_id ?? '' == $country->id ? 'selected' : ' ' }}>
                                                    {{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
