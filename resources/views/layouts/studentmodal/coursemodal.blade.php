                                        ...
                                        <select class="form-select" name="dept_id" required>
                                            ...
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->id }}"
                                                    {{ $stdcourses->dept_id ?? '' == $department->id ? 'selected' : ' ' }}>
                                        ...
                                        <select class="form-select" id="degree" name="prog_id" required>
                                            ...
                                            @foreach ($programmes as $programme)
                                                <option value="{{ $programme->id }}"
                                                    {{ $stdcourses->prog_id ?? '' == $programme->id ? 'selected' : ' ' }}>
                                                    {{ $programme->description }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="filed_of_interest" name="course_id" required>
                                            <option selected disabled>Select Field of Interest</option>
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    {{ $stdcourses->course_id ?? '' == $course->id ? 'selected' : ' ' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="Mode of Study" name="mode_of_study" required>
                                            <option value="{{ $stdcourses->mode_of_study ?? '' }}">
                                                {{ $stdcourses->mode_of_study ?? '' }}</option>
