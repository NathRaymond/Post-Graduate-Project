	...
	<div class="d-flex align-items-center logo-box justify-content-start d-md-none d-block">
		...
		<a href="index.html" class="logo">
		  ...
		  <div class="logo-mini w-30">
			  <span class="light-logo"><img src="{{ asset('adminassets/images/logo-letter.png')}}" alt="logo"></span>
			  <span class="dark-logo"><img src="{{ asset('adminassets/images/logo-letter-white.png')}}" alt="logo"></span>
		  </div>
		  <div class="logo-lg">
			  <span class="light-logo"><img src="{{ asset('adminassets/images/logo-dark-text.png')}}" alt="logo"></span>
			  <span class="dark-logo"><img src="{{ asset('adminassets/images/logo-light-text.png')}}" alt="logo"></span>
		  </div>
		</a>
	</div>
    <!-- Header Navbar -->
					...
					<div class="box">
						<div class="box-body">
							<div class="d-flex justify-content-between">
								...
								<div>
									<img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-26.svg" class="w-100" alt="" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="table-responsive">
							  	<table class="table table-hover">
									<tbody>
										...
										<tr>
										  <td><img src="{{ asset('adminassets/images/avatar/avatar-1.png')}}" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="{{ asset('adminassets/images/avatar/avatar-2.png')}}" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="{{ asset('adminassets/images/avatar/avatar-3.png')}}" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="{{ asset('adminassets/images/avatar/avatar-4.png')}}" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="{{ asset('adminassets/images/avatar/avatar-5.png')}}" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="{{ asset('adminassets/images/avatar/avatar-6.png')}}" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
										...
										<tr>
										  <td><img src="{{ asset('adminassets/images/avatar/avatar-7.png')}}" class="avatar avatar-lg rounded10 bg-primary-light" alt=""></td>
							...
							<div class="complaint-bx">
								<div class="box no-shadow">
									<div class="box-body">
										<div class="d-flex align-items-center">
											<div class="me-15">
												<img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-22.svg" alt="" class="w-100" />
											</div>
											<div>
								...
								<div class="box no-shadow">
									<div class="box-body">
										<div class="d-flex align-items-center">
											<div class="me-15">
												<img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-29.svg" alt="" class="w-100" />
											</div>
											<div>
								...
								<div class="box no-shadow">
									<div class="box-body">
										<div class="d-flex align-items-center">
											<div class="me-15">
												<img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-28.svg" alt="" class="w-100" />
											</div>
											<div>
								...
								<div class="box no-shadow">
									<div class="box-body">
										<div class="d-flex align-items-center">
											<div class="me-15">
												<img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-23.svg" alt="" class="w-100" />
											</div>
											<div>
		  ...
		  <div class="modal-body px-30 pb-30 bg-white slim-scroll4">
				<div class="d-flex align-items-center justify-content-between pb-15">
					...
					<a href="#" class="flex-shrink-0">
						<img src="{{ asset('adminassets/images/product/product-1.png')}}" class="avatar h-100 w-100" alt="" />
					</a>
				</div>
			  <div class="dropdown-divider"></div>
				<div class="d-flex align-items-center justify-content-between py-15">
					...
					<a href="#" class="flex-shrink-0">
						<img src="{{ asset('adminassets/images/product/product-2.png')}}" class="avatar h-100 w-100" alt="" />
					</a>
				</div>
			  <div class="dropdown-divider"></div>
				<div class="d-flex align-items-center justify-content-between py-15">
					...
					<a href="#" class="flex-shrink-0">
						<img src="{{ asset('adminassets/images/product/product-3.png')}}" class="avatar h-100 w-100" alt="" />
					</a>
				</div>
			  <div class="dropdown-divider"></div>
				<div class="d-flex align-items-center justify-content-between py-15">
					...
					<a href="#" class="flex-shrink-0">
						<img src="{{ asset('adminassets/images/product/product-4.png')}}" class="avatar h-100 w-100" alt="" />
					</a>
				</div>
			  <div class="dropdown-divider"></div>
				<div class="d-flex align-items-center justify-content-between py-15">
					...
					<a href="#" class="flex-shrink-0">
						<img src="{{ asset('adminassets/images/product/product-5.png')}}" class="avatar h-100 w-100" alt="" />
					</a>
				</div>
			  <div class="dropdown-divider"></div>
				<div class="d-flex align-items-center justify-content-between py-15">
					...
					<a href="#" class="flex-shrink-0">
						<img src="{{ asset('adminassets/images/product/product-6.png')}}" class="avatar h-100 w-100" alt="" />
					</a>
				</div>
		  </div>
                ...
                <div class="row">
                    <div class="col-xl-8 pe-xl-0">
                        <div class="card text-white mb-0 b-0" style="margin-bottom: 0 !important;">
                            <img class="card-img" src="{{ asset('adminassets/images/preview/bg.jpg')}}" alt="Card image">
                        ...
                        <div class="card no-shadow b-0" style="margin-bottom: 0 !important;">
                            <div class="test">
                                <div class="card-header d-block">
                                    <div class="media p-0">
                                        <img class="img-fluid w-50 ms-0" src="{{ asset('adminassets/images/avatar/1.jpg')}}" alt="placeholder image">
                                        <div class="media-body">
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="d-inline-block">
                                                <a href="#">
                                                    <img class="img-fluid w-30" src="{{ asset('adminassets/images/avatar/3.jpg')}}" alt="placeholder image">
                                                </a>
                                                <a href="#">
                                                    <img class="img-fluid w-30" src="{{ asset('adminassets/images/avatar/4.jpg')}}" alt="placeholder image">
                                                </a>
                                                <a href="#">
                                                    <img class="img-fluid w-30" src="{{ asset('adminassets/images/avatar/5.jpg')}}" alt="placeholder image">
                                                </a>
                                                <a href="#">
                                                    <img class="img-fluid w-30" src="{{ asset('adminassets/images/avatar/6.jpg')}}" alt="placeholder image">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-auto">
